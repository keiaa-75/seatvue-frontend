...
<template>
  <div>
    <section class="hero is-primary is-medium card flat-squared">
    ...
    <div class="container p-4">
      ...
      <div class="notification is-info is-light card flat-squared">
        <p>This project is still under development. You can follow the progress on GitHub.</p>
      </div>

      <RouterLink to="/manage" class="button is-fullwidth is-large btn-primary flat-squared">
